...
CREATE TABLE customer (
    ...
    password CHARACTER VARYING(300) DEFAULT NULL,
    phone CHARACTER VARYING(30) UNIQUE DEFAULT NULL,
...
CREATE TABLE coinswap (
    ...
    transaction_status CHARACTER VARYING(100) DEFAULT 'STALE' NOT NULL,
    current_usdt_ngn_rate CHARACTER VARYING(100) NOT NULL,
    customer_id INT NOT NULL,
    ngn_equivalent numeric(50,8) NOT NULL,
    payout_status CHARACTER VARYING(100) DEFAULT 'STALE' NOT NULL,
